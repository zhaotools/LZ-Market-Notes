...
const data={site:await readJSON('site.json'),articles:validateContent(await readJSON('articles.json'),'articles'),videos:validateContent(await readJSON('videos.json'),'videos'),market:validateMarket(await readJSON('market.json'))};
